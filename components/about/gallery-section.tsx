        ...
        >
          ...
          <div className="flex flex-wrap justify-center gap-2 mb-8">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className={`px-4 py-2 rounded-full text-sm font-medium ${
                filter === "Team" ? "bg-amber-600 text-white" : "bg-muted text-muted-foreground hover:bg-muted/80"
              }`}
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className={`px-4 py-2 rounded-full text-sm font-medium ${
                filter === "Events" ? "bg-amber-600 text-white" : "bg-muted text-muted-foreground hover:bg-muted/80"
              }`}
