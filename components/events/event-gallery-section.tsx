...
//   const categories = ["Fun", "Workshop", "Competition", "Networking"]
...
//                 whileHover={{ scale: 1.05 }}
//                 whileTap={{ scale: 0.95 }}
//                 className={`px-4 py-2 rounded-full text-sm font-medium ${filter === category ? "bg-amber-600 text-white" : "bg-muted text-muted-foreground hover:bg-muted/80"
//                   }`}
