...
export default function AboutSection() {
  ...
  return (
    <section id="about" className="relative overflow-hidden bg-muted/30 py-24 dark:bg-muted/10" ref={ref}>
      {/* Background pattern with the provided image */}
      ...
      <div className="container relative z-10 px-4">
        ...
        >
          ...
          {/* Framed content with border and background image */}
          <div className="relative mx-auto rounded-xl p-1 shadow-xl">
            {/* Border frame with gradient */}
            <div className="absolute inset-0 rounded-xl bg-gradient-to-br from-amber-400 via-amber-600 to-teal-700 opacity-70"></div>
            ...
            <div className="relative rounded-lg overflow-hidden">
              ...
              {/* Content */}
              <div className="relative bg-card/80 backdrop-blur-sm p-8 rounded-lg">
                <motion.div
                  initial={{ opacity: 0 }}
